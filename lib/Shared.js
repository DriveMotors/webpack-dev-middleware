...
module.exports = function Shared(context) {
	var share = {
		...
		setFs: function(compiler) {
			...
			var fs;
			if (context.options.useRealFileSystem && compiler.outputFileSystem) {
				fs = compiler.outputFileSystem;

				// monkey patch since NodeOutputFileSystem doesn't have methods below
				var FileSystem = require('fs');
				fs.statSync = FileSystem.statSync;
